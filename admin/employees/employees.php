...
<html lang="en">
	...
	<head>
		<base href="../">
		<meta charset="utf-8" />
		<title>Employees | <?php echo $site_title; ?></title>
	...
	<body class="kt-page-content-white kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-page--loading">
										...
										<div class="kt-portlet__head kt-portlet__head--lg">
											...
											<div class="kt-portlet__head-toolbar">
												<div class="kt-portlet__head-wrapper">
													<a href="employees/new-employee" class="btn btn-primary btn-icon-sm">
														New Employee
													</a>
												</div>
											</div>
		...
		<script src="assets/js/pages/custom/employees/all-employees.js" type="text/javascript"></script>
