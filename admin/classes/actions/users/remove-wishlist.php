...
try {
    ...
    $product_id = isset($_POST['product_id']) ? $reg_activity->formatInput($_POST['product_id']) : 0;
    
    $get_request = json_encode($_POST);
    
    // Initialize report variables
    $reg_activity->setReportType("Removed Wishlist");
    ...
    $reg_activity->setReportTypeId($product_id);
