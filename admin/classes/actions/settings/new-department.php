...
try {
    ...
    $reg_activity->setReportType("New Department");
    ...
    $new_department = new Settings\Department();
    $response = $new_department->newDepartment($name);

    // Register request as successful
    $reg_activity->setReportTypeId(0);

    $description = $employee_Details->first_name . " created new department ".strtoupper($name);
