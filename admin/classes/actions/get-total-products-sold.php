...
try {
    ...
    $reg_activity->setReportType("Retrieved Total Products Sold");
    ...
    $response = $products->getTotalProductSold($from_date, $to_date );

    $description = $employee_Details->first_name ." retrieved total products sold";
