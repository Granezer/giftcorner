				...
				template: function(data, i) {
					...
					var output = '<div class="kt-user-card-v2">\
						<div class="kt-user-card-v2__pic">\
							<img src="' + data.profile_image_url + '" alt="photo">\
						</div>\
						<div class="kt-user-card-v2__details">\
							<a href="users/overview?user_id=' + data.id + '" class="kt-user-card-v2__name">' + data.fullname + '</a>\
							<span class="kt-user-card-v2__desc">' + gender + '</span>\
						</div>\
					</div>';
