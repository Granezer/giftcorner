...
var KTAllPaymentHistory = function() {
	...
	var init = function() {
		...
		datatable = $('#kt_payment_history').KTDatatable({
			...
			data: {
				...
				source: {
					read: {
						...
						url: endPoint + 'all-payment-history',
					},
				},
				saveState: {
					webstorage: false,
			...
			layout: {
				...
				spinner: {
					message: "Loading all payment history. Please wait...",
				},
			},
			...
			datatable: {
				getTotalRow: $('#kt_subheader_total'),
			},
