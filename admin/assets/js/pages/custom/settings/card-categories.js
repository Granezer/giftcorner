		...
		datatable = $('#kt_apps_user_list_datatable').KTDatatable({
			...
			data: {
				...
				source: {
					read: {
						...
						url: endPoint + 'settings/get-card-categories',
					},
				},
			...
			columns: [{
                ...
                template: function(data) {
	                ...
	                var image = "../backend/assets/media/giftcards/" + data.image_url;
	                var output = '\
                ...
                template: function(row) {
                    var output = '\
                        <a href="settings/edit-card-category?id=' + row.id + '" style="color:#666;">'+ row.name +'</a>';
								...
								<div class="dropdown-menu dropdown-menu-right">\
									<ul class="kt-nav">\
										<li class="kt-nav__item">\
											<a href="settings/edit-card-category?id=' + row.id + '" class="kt-nav__link">\
