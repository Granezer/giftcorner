		...
		datatable = $('#kt_apps_user_list_datatable').KTDatatable({
			...
			columns: [{
                ...
                template: function(row) {
                    var output = '\
                        <a href="settings/edit-system-user?id=' + row.id + '" style="color:#666;">'+ row.employee_name +'</a>';
                ...
                template: function(row) {
                    var output = '\
                        <a href="settings/edit-system-user?id=' + row.id + '" style="color:#666;">'+ row.role_name +'</a>';
								...
								<div class="dropdown-menu dropdown-menu-right">\
									<ul class="kt-nav">\
										<li class="kt-nav__item">\
											<a href="settings/edit-system-user?id=' + row.id + '" class="kt-nav__link">\
