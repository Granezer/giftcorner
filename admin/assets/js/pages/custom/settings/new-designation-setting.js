...
// Class Definition
var KTNewDesignationSetting = function() {

    var handleNewDesignationSetting = function() {
        $('#new_designation_setting_submit').click(function(e) {
            e.preventDefault();
            ...
            form.ajaxSubmit({
                ...
                success: function(response, status, xhr, $form) {
                    ...
                    if (response['success']) {
                        ...
                        swal.fire({
                            "title": "New Designation Setting Error",
                            "text": response['message'],
                            "type": "warning",
                            "confirmButtonClass": "btn btn-secondary"
                        });
