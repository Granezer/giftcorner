...
<html lang="en">
	...
	<head>
		<base href="../">
		<meta charset="utf-8" />
		<title>Basic Info | <?php echo $site_title; ?></title>
	...
	<body class="kt-page-content-white kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-page--loading">
									...
									<div class="kt-container ">
										<div class="kt-subheader__main">
											...
											<div class="kt-subheader__breadcrumbs">
												...
												<a href="profile/basic-info?id=<?php echo $id;?>" class="kt-subheader__breadcrumbs-link">
													Basic Information </a>
											</div>
										</div>
									</div>
													...
													<div class="kt-portlet">
														<div class="kt-portlet__head">
															<div class="kt-portlet__head-label">
																<h3 class="kt-portlet__head-title">Basic Information <small>update your basic informaiton</small></h3>
															</div>
																...
																<div class="kt-section kt-section--first">
																	<div class="kt-section__body">
																		...
																		<div class="form-group row">
																			...
																			<div class="col-lg-9 col-xl-6">
																				<div class="kt-avatar kt-avatar--outline" id="kt_user_avatar">
																					<div class="kt-avatar__holder" style="background-image: url(<?php echo $employee->profile_image; ?>)"></div>
																		...
																		<div class="form-group row">
																			...
																			<div class="col-lg-9 col-xl-6">
																				<input class="form-control" type="text" name="title" value="<?php echo $employee->title; ?>">
																			</div>
																		</div>
																		<div class="form-group row">
																		...
																		<div class="form-group row">
																			...
																			<div class="col-lg-9 col-xl-6">
																				<select class="form-control" name="marital_status">
																					<option value="female" <?php if($employee->marital_status=='married') echo 'selected' ;?>>Married</option>
																					<option value="single" <?php if($employee->marital_status=='single') echo 'selected' ;?>>Single</option>
																					<option value="prefer not to say" <?php if($employee->marital_status=='prefer not to say') echo 'selected' ;?>>Prefer not to say</option>
																				</select>
																			</div>
																		</div>
																		<div class="form-group row">
																			...
																			<div class="col-lg-9 col-xl-6">
																				<input class="form-control" type="text" value="<?php echo $employee->place_of_birth; ?>" name="place_of_birth" >
																			</div>
																		</div>
																		<div class="form-group row">
																			<label class="col-xl-3 col-lg-3 col-form-label">Date of Birth</label>
																			<div class="col-lg-9 col-xl-6">
																				<input type="text" class="form-control" id="dob" readonly="" placeholder="Select date of birth" name="dob" value="<?php echo $employee->dob; ?>">
																			</div>
																		</div>
																	</div>
																</div>
																...
																<div class="kt-form__actions">
																	<div class="row">
																		...
																		<div class="col-lg-9 col-xl-9">
																			<button type="button" class="btn btn-danger" id="update_employee_basic_info_submit">Update</button>&nbsp;
		...
		<script src="assets/js/pages/custom/employees/update-employee.js?p=2" type="text/javascript"></script>
