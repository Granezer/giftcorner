...
$header = "activities";
$pageName = "merchant-user-activities";
...
<html lang="en">
	...
	<head>
		<base href="../">
		<meta charset="utf-8" />
		<title>Acitivities | <?php echo $site_title; ?></title>
	...
	<body class="kt-page-content-white kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-page--loading">
											...
											<div class="row">
												<div class="col-xl-12">
													<div class="kt-portlet kt-portlet--height-fluid">
														...
														<!--begin: Datatable -->
														<div class="kt-datatable" id="load_activities"></div>
														<!--end: Datatable -->
		...
		<script src="assets/js/pages/custom/activities/activities.js" type="text/javascript"></script>
		<!--end::Page Scripts -->
	</body>
