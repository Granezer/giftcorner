...
$pageName = "merchant-user-wish-lists";
...
<html lang="en">
	...
	<head>
		<base href="../">
		<meta charset="utf-8" />
		<title>Wish List | <?php echo $site_title; ?></title>
	...
	<body class="kt-page-content-white kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-page--loading">
								...
								<div class="kt-subheader   kt-grid__item" id="kt_subheader">
									<div class="kt-container ">
										<div class="kt-subheader__main">
											...
											<h3 class="kt-subheader__title">Wish Lists</h3>
										</div>
									</div>
								</div>
											...
											<div class="row">
												<div class="col-xl-12">
													<div class="kt-portlet kt-portlet--height-fluid">
														...
														<!--begin: Datatable -->
														<div class="kt-datatable" id="load_wish_lists"></div>
														<!--end: Datatable -->
		...
		<script src="assets/js/pages/custom/wish-lists/wish-lists.js" type="text/javascript"></script>
		<!--end::Page Scripts -->
	</body>
