...
$header = "merchant-orders";
$pageName = "merchant-user-orders";
...
<html lang="en">
	...
	<head>
		<base href="../">
		<meta charset="utf-8" />
		<title><?php echo $title; ?> Orders | <?php echo $site_title; ?></title>
	...
	<body class="kt-page-content-white kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-page--loading">
		...
		<script type="text/javascript">
			var p = getUrlParams(),
				buyer_id = p.hasOwnProperty("user_id") ? p['user_id'] : 0,
				order_status = p.hasOwnProperty("status") ? p['status'] : '100';
		...
		<script src="assets/js/pages/custom/orders/buyer-orders.js" type="text/javascript"></script>
		<!--end::Page Scripts -->
	</body>
