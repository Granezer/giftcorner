...
$end_point = $end_point . $page . $params;
...
<html lang="en">
	...
	<head>
		<base href="../">
		<meta charset="utf-8" />
		<title>User Payment Details | <?php echo $site_title; ?></title>
								...
								<div class="kt-subheader   kt-grid__item" id="kt_subheader">
									<div class="kt-container ">
										<div class="kt-subheader__main">
											<h3 class="kt-subheader__title">Payment Details</h3>
											<span class="kt-subheader__separator kt-subheader__separator--v"></span>
											<span class="kt-subheader__desc">#<?php echo $response['reference_no'];?></span>
										</div>
										<div class="kt-portlet__head-toolbar">
											<div class="kt-portlet__head-wrapper">
												<a href="payments/user-payments" class="btn btn-clean btn-icon-sm">
													...
													<div class="kt-invoice__container">
														<div class="kt-invoice__brand">
															...
															<div class="kt-invoice__logo">
																<?php
																$status = "success";
																if ($response['status'] == 'Pending') $status = "warning";
																elseif ($response['status'] == 'Cancelled') $status = "danger";
																?>
																<b>Payment Status</b>
														...
														<div class="table-responsive">
															<table class="table">
																...
																<tbody>
																	...
																	<?php
																	if ($response['payment_mode'] != "Direct Transfer") {
																	?>
																	<!-- <tr>
																		<td>&nbsp;</td>
													...
													<div class="kt-invoice__container">
														<div class="table-responsive">
															<table class="table">
																...
																<tbody>
																	<tr>
																		<td><?php echo $response['payment_mode']; ?></td>
																		<td><?php echo $response['total_amount_paid']; ?></td>
																		<td><?php echo $response['amount_paid']; ?></td>
																		<td>
																			<?php 
																			$total_amount = (float) str_replace(",", '', $response['total_amount']);
																			$total_amount_paid = (float) str_replace(",", '', $response['total_amount_paid']);
																			$amount_paid = 0;
																			if($response['status']=="Confirmed"){
																				$amount_paid = (float) str_replace(',', '', $response['amount_paid']);
																			}
																			echo number_format(($total_amount - $total_amount_paid - $amount_paid)); 
																			?>
																				
																		</td>
																		<td class="kt-font-danger kt-font-xl kt-font-boldest"><?php echo $response['total_amount']; ?></td>
																	</tr>
																</tbody>
															</table>
														</div>
												...
												<div class="kt-invoice__actions">
													<div class="kt-invoice__container">
														<form>
															...
															<input type="hidden" name="payment_id" value="<?php echo $response['id']; ?>">
															<?php
